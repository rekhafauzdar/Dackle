			...
			<form action="/order_preview">
                ...
                <div class="row">
                    <div class="mb-3 row">
                        ...
                        <div class="col-lg-1 col-md-2 col-sm-2">
                            <input name="quantity" type="text" class="form-control" id="quantity"  placeholder="Qty." >
                        </div>
                 ...
                 <div class="row">
                    <div class="mb-3 row">  
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2">
                            <button type="submit" class="btn btn-success" style="border-radius:40px; width:100%;">View Orders</button>
                        </div>
                    </div>
                </div>
                        ...
                        <thead>
                            <tr style="border:2px solid black">
                             ...
                             <th scope="col" style="width:10%;">Paper Type</th>    
                                ...
                                <th scope="col" style="width:30%;">Party Name</th>
                        ...
                        <tbody id="tbody">
                       		...
                       		for(DackleOrders order:orders){
                       		 ...
                       		 SimpleDateFormat formate=new SimpleDateFormat("dd/MM/yyyy");  
                       			...
                       			%>
                       			 <tr>
                                      <td><%=formate.format(order.getOrdDate())%></td>
                                        <td><%=order.getPapertype()==1?"Classic":"Crystal" %></td>
                                           <td><%=order.getGsm() %></td>
                                            
                                            <td><%=order.getPartyName() %></td>
                                            <td><%=order.getWidth()+ " X " +order.getLength() %></td>
