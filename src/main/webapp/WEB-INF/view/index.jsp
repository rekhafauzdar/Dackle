...
<div class="container1">
		...
		<div id="hiddendiv" >
			...
			<div class="col-lg-1 col-md-3 col-sm-3" >
				...
				<div class="col-lg-1 col-md-1 col-sm-1">
					<input type="text" name="gsm" class="form-control" id="gsm"	placeholder="GSM" onkeypress="return((event.charCode >= 48 && event.charCode <= 57) || (event.charCode == 46))" required />
				</div>
				...
				<div class="col-lg-3 col-md-2 col-sm-2">
					<input name="partyname" type="text" class="form-control" id="partyname" placeholder="Party Name" onkeypress="return((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32 )  )"  required>
				</div>
			...
			<div class="col-lg-1 col-md-2 col-sm-2">
				...
				<div class="col-lg-1 col-md-1 col-sm-1">
					<input name="quantity" type="text" class="form-control"	id="quantity" placeholder="Qty" onkeypress="return((event.charCode >= 48 && event.charCode <= 57) || (event.charCode == 46))" required>
				</div>
				...
				<div class="col-lg-1 col-md-1 col-sm-1">
					<input name="paper_width" type="text" class="form-control"	id="paper_width" placeholder="Width" onkeypress="return((event.charCode >= 48 && event.charCode <= 57) || (event.charCode == 46))" required>
				</div>
				<div class="col-lg-1 col-md-1 col-sm-1">
					<label for="exampleFormControlInput1" class="form-label">Length</label>
				</div>
				<div class="col-lg-1 col-md-1 col-sm-1">
					<input name="paper_length" type="text" class="form-control"	id="paper_length" placeholder="Length" onkeypress="return((event.charCode >= 48 && event.charCode <= 57) || (event.charCode == 46))" required>
				</div>
			...
			<form action="/calculate" method="post">
				...
				<div id="logo" style="display: none; float:center; text-align:center;">
				 <img src="images/sppl_Logo.png" alt=""  >
				</div>
				
			<lable hidden="true" id="orders"><h4>Orders</h4></lable>	
...
<div class="container1">
<lable hidden="true" id="orders"><h4>Dackle Planning</h4></lable>
		<table class="table orders">
			<thead >				
				<tr style="border:2px solid black">
			...
			<tr><td colspan="6"><h6 style="color:#04888d;"><u style="color:green;"> Dackle Planning with less than or equal to 8cm. Wastage</u></h6></td></tr>
				...
				<tr><td colspan="6"><h6 style="color:#04888d;"><u style="color:green;"> Dackle Planning with more than 8cm Wastage.</u></h6></td></tr>
...
<lable hidden="true" id="orders"><h4>Remaining Qty</h4></lable>
<table class="table orders" >
			<thead>				
				<tr style="border:2px solid black">
